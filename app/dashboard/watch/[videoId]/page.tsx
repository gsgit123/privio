...
export default function WatchPage() {
  ...
  // ✅ useCallback so HlsPlayer's useEffect dep array stays stable
  // Without this, a new function reference is created on every render,
  // causing the event listener to re-register and fire multiple times.
    ...
    <div className="bg-black min-h-screen text-white flex flex-col">
      ...
      <div className="fixed inset-0 opacity-10 pointer-events-none">
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(to right, rgba(0, 128, 128, 0.3) 1px, transparent 1px), linear-gradient(to bottom, rgba(0, 128, 128, 0.3) 1px, transparent 1px)",
      ...
      <nav className="relative border-b border-teal-900/30 bg-gray-900 backdrop-blur-sm">
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <Link href="/dashboard" className="text-sm text-gray-400 hover:text-teal-400 whitespace-nowrap">
            ← Back to Dashboard
          </Link>
        </div>
      </nav>
